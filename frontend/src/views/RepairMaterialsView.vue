<template>
  <div class="repair-materials-container">
    <el-card>
      <!-- 搜索表单 -->
      <el-form :inline="true" :model="searchForm" class="search-form">
        ...
        <el-form-item :label="$t('repairMaterials.category')">
          <el-select
    ...
    >
      <el-form :model="form" :rules="rules" ref="formRef" label-width="120px">
        ...
        <el-form-item :label="$t('repairMaterials.stockQuantity')" prop="stockQuantity">
          <el-input-number v-model="form.stockQuantity" :min="0" :precision="2" />
        </el-form-item>
    ...
    >
      <el-form :model="stockForm" label-width="100px">
        ...
        <el-form-item :label="$t('repairMaterials.changeQuantity')">
          <el-input-number v-model="stockForm.quantity" :precision="2" />
