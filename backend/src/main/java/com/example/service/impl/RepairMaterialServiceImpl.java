...
public class RepairMaterialServiceImpl implements RepairMaterialService {
    ...
    private final RepairMaterialMapper materialMapper;
    private final RepairRecordMaterialMapper recordMaterialMapper;

    public RepairMaterialServiceImpl(RepairMaterialMapper materialMapper,
                                     RepairRecordMaterialMapper recordMaterialMapper) {
